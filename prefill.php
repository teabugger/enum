...
$replacements = [
    'teabugger\\\\Enum\\\\' => function () use(&$values) { return str_replace('\\', '\\\\', $values['psr4_namespace']) . '\\\\'; },
    'Maksim Kolesnik'                 => function () use(&$values) { return $values['author_name']; },
    'teabugger'             => function () use(&$values) { return $values['author_github_username']; },
    'https://github.com/teabugger'              => function () use(&$values) { return $values['author_website'] ?: ('https://github.com/' . $values['author_github_username']); },
    'kolesnik.teabugger@gmail.com'                => function () use(&$values) { return $values['author_email'] ?: ($values['author_github_username'] . '@example.com'); },
    'teabugger'                      => function () use(&$values) { return $values['package_vendor']; },
    'Enum'                => function () use(&$values) { return $values['package_name']; },
    'PHP ENUM implementation'         => function () use(&$values) { return $values['package_description']; },
